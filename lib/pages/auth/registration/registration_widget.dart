...
class _RegistrationWidgetState extends State<RegistrationWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('REGISTRATION_registration_ON_INIT_STATE');
      logFirebaseEvent('registration_firestore_query');
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('REGISTRATION_arrow_back_sharp_ICN_ON_TAP');
                  ...
                  children: [
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        options: _model.users!.map((e) => e.residence).toList(),
                        onChanged: (val) =>
                        ...
                        hintText: FFLocalizations.of(context).getText(
                          'iy64w4xh' /* Select your Apartment or Resid... */,
                        ),
                        searchHintText: FFLocalizations.of(context).getText(
                          'km9j0wzk' /* Search for an item... */,
                        ),
                        icon: Icon(
