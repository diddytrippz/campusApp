            ...
            Expanded(
              child: StreamBuilder<List<MaintenanceRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<MaintenanceRecord> mainContentMaintenanceRecordList =
                      snapshot.data;
                  if (mainContentMaintenanceRecordList.isEmpty) {
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      ...
                      children:
                          List.generate(mainContentMaintenanceRecordList.length,
                              (mainContentIndex) {
                        final mainContentMaintenanceRecord =
                            mainContentMaintenanceRecordList[mainContentIndex];
                        return SingleChildScrollView(
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  0, 4, 4, 0),
                                                      child: Text(
                                                        'Please note that we are still waiting for supplies to be delivered, your request will be attended soon.',
                                                        style: FlutterFlowTheme
                                                            .bodyText2
                                                            .override(
                                                          fontFamily:
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  0, 4, 4, 0),
                                                      child: Text(
                                                        'Bookings for 2022 will open on the 1st of september. Please ensure that you make your bookings in time to avoid disappointment. ',
                                                        textAlign:
                                                            TextAlign.start,
                                                        style: FlutterFlowTheme
                                                            .bodyText2
