...
class _SettingsCopyWidgetState extends State<SettingsCopyWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('SETTINGS_COPY_settingsCopy_ON_INIT_STATE');
      if ((Theme.of(context).brightness == Brightness.dark) == true) {
        logFirebaseEvent('settingsCopy_update_page_state');
        _model.system = 'Dark';
        safeSetState(() {});
      } else if ((Theme.of(context).brightness == Brightness.light) == true) {
        logFirebaseEvent('settingsCopy_update_page_state');
        _model.system = 'Light';
        safeSetState(() {});
      } else {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<MaintenanceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MaintenanceRecord> settingsCopyMaintenanceRecordList =
            snapshot.data!;
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'SETTINGS_COPY_ListTile_97x20yjz_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'SETTINGS_COPY_ListTile_dysvl8u8_ON_TAP');
                            logFirebaseEvent('ListTile_navigate_to');
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'SETTINGS_COPY_ListTile_jowshoc0_ON_TAP');
                            logFirebaseEvent('ListTile_navigate_to');
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'SETTINGS_COPY_PAGE_Icon_d07a655j_ON_TAP');
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SETTINGS_COPY_PAGE_Row_5oume9bz_ON_TAP');
                                              logFirebaseEvent(
                                                  'Row_navigate_to');
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SETTINGS_COPY_PAGE_Row_n08gg1i2_ON_TAP');
                                              logFirebaseEvent(
                                                  'Row_navigate_to');
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SETTINGS_COPY_PAGE_Row_tgga4vdk_ON_TAP');
                                              logFirebaseEvent(
                                                  'Row_navigate_to');
                                          ...
                                          Builder(
                                            builder: (context) => InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'SETTINGS_COPY_PAGE_Row_auoyyxxx_ON_TAP');
                                                if (isWeb == true) {
                                                  logFirebaseEvent(
                                                      'Row_custom_action');
                                                  await actions
                                                      .downloadCollectionAsCSV(
                                                    settingsCopyMaintenanceRecordList
                                                        .toList(),
                                                  );
                                                } else {
                                                  logFirebaseEvent(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'SETTINGS_COPY_Container_sk9e0ma6_ON_TAP');
                                                    logFirebaseEvent(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'SETTINGS_COPY_Container_7ewtuz0b_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Container_set_dark_mode_settings');
                                                    setDarkModeSetting(context,
                                                        ThemeMode.light);
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'SETTINGS_COPY_Container_b0xvgj9f_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Container_set_dark_mode_settings');
                                                    setDarkModeSetting(context,
                                                        ThemeMode.light);
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SETTINGS_COPY_PAGE_Row_5zjgdd8x_ON_TAP');
                                              logFirebaseEvent(
                                                  'Row_send_email');
                                              await launchUrl(Uri(
                                                  scheme: 'mailto',
                                                  path:
                                                      'lincolnmudau1@gmail.com',
                                                  query: {
                                                    'subject': 'Found a Bug!',
                                                  }
                                                      .entries
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SETTINGS_COPY_PAGE_Row_c79bh1jo_ON_TAP');
                                              logFirebaseEvent(
                                                  'Row_launch_u_r_l');
                                              await launchURL(
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SETTINGS_COPY_PAGE_Row_7xwn2qir_ON_TAP');
                                              logFirebaseEvent(
                                                  'Row_launch_u_r_l');
                                              await launchURL(
                                                  'https://campusafrica.co.za/contact-us/');
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SETTINGS_COPY_PAGE_Row_s0riqqxa_ON_TAP');
                                              if (isiOS == true) {
                                                logFirebaseEvent(
                                                    'Row_launch_u_r_l');
                                                await launchURL(
                                                    'https://apps.apple.com/za/app/campus-africa/id1607476667');
                                              } else if (isAndroid == true) {
                                                logFirebaseEvent(
                                                    'Row_launch_u_r_l');
                                                await launchURL(
                                                    'https://play.google.com/store/apps/details?id=com.campusafrica.app&hl=en_US&gl=US&pli=1');
                                              } else {
                                                logFirebaseEvent(
                                                    'Row_launch_u_r_l');
                                                await launchURL(
                                                    'https://campusafrica.co.za/');
                                              }
                                            },
                                            child: Row(
                                              mainAxisSize: MainAxisSize.max,
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SETTINGS_COPY_Container_ynb725nd_ON_TAP');
