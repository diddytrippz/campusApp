...
class RepairStatusWidget extends StatefulWidget {
  const RepairStatusWidget({Key key}) : super(key: key);

  @override
  _RepairStatusWidgetState createState() => _RepairStatusWidgetState();
}

class _RepairStatusWidgetState extends State<RepairStatusWidget> {
