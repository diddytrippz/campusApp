...
import 'submitted_icon_model.dart';
export 'submitted_icon_model.dart';

class SubmittedIconWidget extends StatefulWidget {
  const SubmittedIconWidget({
    super.key,
    this.refNo,
  });
  ...
  @override
  State<SubmittedIconWidget> createState() => _SubmittedIconWidgetState();
}

class _SubmittedIconWidgetState extends State<SubmittedIconWidget>
    with TickerProviderStateMixin {
  late SubmittedIconModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubmittedIconModel());
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'nyzsxlkf' /* Your ticket has been received
... */
                                                ,
                                              ),
                                              textAlign: TextAlign.center,
