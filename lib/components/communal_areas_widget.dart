...
class CommunalAreasWidget extends StatefulWidget {
  const CommunalAreasWidget({Key key}) : super(key: key);

  @override
  _CommunalAreasWidgetState createState() => _CommunalAreasWidgetState();
}

class _CommunalAreasWidgetState extends State<CommunalAreasWidget>
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown(
                        options: [
                          'Xbox controller broken',
                          'TV remote broken',
                          'Pool sticks are broken',
                          'Missing pool balls'
                        ].toList(),
