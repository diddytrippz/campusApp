...
class NavBarzWidget extends StatefulWidget {
  const NavBarzWidget({Key? key}) : super(key: key);

  @override
  _NavBarzWidgetState createState() => _NavBarzWidgetState();
}

class _NavBarzWidgetState extends State<NavBarzWidget>
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'NAV_BARZ_COMP_IconInbox_ON_TAP');
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'NAV_BARZ_COMP_IconSettings_ON_TAP');
                                logFirebaseEvent(
            ...
            child: Material(
              ...
              child: Container(
                ...
                child: FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    logFirebaseEvent('NAV_BARZ_COMP_add_ICN_ON_TAP');
