...
import 'no_network_model.dart';
export 'no_network_model.dart';
...
class _NoNetworkWidgetState extends State<NoNetworkWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoNetworkModel());
                                    ...
                                    children: [
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'eenc4t50' /* No network Connection. Try
aga... */
                                              ,
                                            ),
                                            textAlign: TextAlign.center,
