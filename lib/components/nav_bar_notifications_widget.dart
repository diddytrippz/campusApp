                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'NAV_BAR_NOTIFICATIONS_IconEdit_ON_TAP');
                            ...
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'NAV_BAR_NOTIFICATIONS_IconInbox_ON_TAP');
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'NAV_BAR_NOTIFICATIONS_IconNoti_ON_TAP');
                            ...
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'NAV_BAR_NOTIFICATIONS_IconSettings_ON_TA');
                                logFirebaseEvent(
            ...
            child: Material(
              ...
              child: Container(
                ...
                child: FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    logFirebaseEvent('NAV_BAR_NOTIFICATIONS_add_ICN_ON_TAP');
