...
class _LocksmithWidgetState extends State<LocksmithWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('LOCKSMITH_PAGE_Locksmith_ON_PAGE_LOAD');
      logFirebaseEvent('Locksmith_update_local_state');
      setState(() {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('LOCKSMITH_arrow_back_sharp_ICN_ON_TAP');
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        options: [
                                          FFLocalizations.of(context).getText(
                                            '6feqgn88' /* Broken door handle (unit) */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'r9o29omx' /* Broken door handle (Room) */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'j3gxrvfc' /* Room key not opening */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'hlrzud1f' /* Unit key not opening */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            '3dhm2b07' /* Lost key */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'zgpjin84' /* Lost access card */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'up7udj4q' /* access card not working */,
                                          )
                                        ],
                                        onChanged: (val) async {
                                          setState(() => budgetValue = val);
                                          logFirebaseEvent(
                                              'LOCKSMITH_budget_ON_FORM_WIDGET_SELECTED');
                                          logFirebaseEvent(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          InkWell(
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'LOCKSMITH_PAGE_Text_c1itdd1q_ON_TAP');
                                              logFirebaseEvent(
                                                  'Text_validate_form');
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          InkWell(
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'LOCKSMITH_PAGE_Text_39qj92co_ON_TAP');
                                              logFirebaseEvent(
                                                  'Text_validate_form');
                                              if (formKey.currentState ==
                                                      null ||
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'LOCKSMITH_PAGE_Text_qnm3dvoz_ON_TAP');
                                                logFirebaseEvent(
                                                    'Text_update_local_state');
                                                setState(() {
                                                  FFAppState().stepper1 = false;
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'b3714jqz' /* Upload Image (Optional) */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                                    .override(
                                      ...
                                      child: Material(
                                        ...
                                        child: Container(
                                          ...
                                          child: InkWell(
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'LOCKSMITH_PAGE_Column_488zhr59_ON_TAP');
                                              logFirebaseEvent(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          InkWell(
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'LOCKSMITH_PAGE_Text_kivm7viy_ON_TAP');
                                              logFirebaseEvent(
                                                  'Text_update_local_state');
                                              setState(() {
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'LOCKSMITH_PAGE_Text_ogstmuv4_ON_TAP');
                                                logFirebaseEvent(
                                                    'Text_update_local_state');
                                                setState(() {
                                                  FFAppState().stepper2 = false;
                      ...
                      child: Row(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'LOCKSMITH_PAGE_SUBMIT_BTN_ON_TAP');
